...
1. warehouse.db — Full SQLite Star Schema Data Warehouse
2. EXECUTIVE_SUMMARY.md — Executive Summary & Decision Matrix
3. DEPLOYMENT_GUIDE.md — Pipeline Deployment & Reproduction Guide
4. analytics.json — 5 SQL Business Queries + Revenue Tie-Out Output
5. audit_report.json — Decision Audit Ledger & Defect Lineage
6. defect_catalog.json — Executable 17-Defect Catalog Spec
7. profile_report.json — Raw Data Profiling Census
8. README.md — Architecture & Scaling Documentation
