...
export const PAGE_PROMPTS: Record<string, PagePrompt[]> = {
  ...
  assistant: [
    ...
    { chip: "Architect technical deep-dive", question: "Provide a Staff Data Architect technical breakdown: star schema design, constraint enforcement, zero-drift reconciliation, and deterministic defect resolution.", scriptedHint: "Run summary" },
  ],
};
