"""SUPERSEDED -- string-faithful CSV reads and atomic JSON writes. Do not read this file as the submission.
...
The maintained implementation is::
    ...
    solution/src/io_utils.py

Reading every CSV with `dtype=str` is what stops pandas from silently coercing a
defect out of existence before the cleaning layer ever sees it.
...
raise RuntimeError(
    "src/io_utils.py at the repository root is a SUPERSEDED first attempt and is retained "
